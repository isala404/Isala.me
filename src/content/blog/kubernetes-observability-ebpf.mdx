...
>
> — [Brendan Gregg](https://www.brendangregg.com/blog/2019-12-02/bpf-a-new-type-of-software.html)
...
![Works on my machine, It's Ops problem now](/images/blog/ebpf/ops-problem-meme.jpg)
...
![High level architecture diagram for this project](/images/blog/ebpf/architecture-diagram.png)
...
![TCP output engine](/images/blog/ebpf/tcp-output-engine.png)
...
![Still with me?](/images/blog/ebpf/its-that-easy-meme.jpg)

Code for the completed probe can be found from [https://github.com/MrSupiri/kube-ebpf/blob/v0.0.1/prober.c](https://github.com/MrSupiri/kube-ebpf/blob/v0.0.1/prober.c)
...
![The components of a Kubernetes cluster](/images/blog/ebpf/kubernetes-components.png)
...
A proper implementation of this which can be integrated with eBPF probe can be found from [https://github.com/MrSupiri/kube-ebpf/blob/v0.0.1/kube_crawler.py](https://github.com/MrSupiri/kube-ebpf/blob/v0.0.1/kube_crawler.py)
...
![We are almost done!](/images/blog/ebpf/yaml-files-meme.jpg)
...
Complete implementation of this process can be found from [https://github.com/MrSupiri/kube-ebpf/blob/v0.0.1/prober.py](https://github.com/MrSupiri/kube-ebpf/blob/v0.0.1/prober.py)
...
![Number of bytes ingested per minute by port and the pod name](/images/blog/ebpf/prometheus-dashboard.png)
...
**GitHub Repository:** [MrSupiri/kube-ebpf at v0.0.1](https://github.com/MrSupiri/kube-ebpf/tree/v0.0.1)
