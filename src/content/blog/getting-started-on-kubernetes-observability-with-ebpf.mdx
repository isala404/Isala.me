...
tags: ['kubernetes', 'ebpf', 'observability', 'prometheus']
seoTags:
  ['ebpf observability', 'kubernetes monitoring', 'ebpf prometheus', 'tcp tracing kubernetes']
featured: true
readingTime: 9
cover: '/images/blog/getting-started-on-kubernetes-observability-with-ebpf/cover.webp'
---
...
![Works on my machine, It's Ops problem now](/images/blog/getting-started-on-kubernetes-observability-with-ebpf/ops-problem-meme.webp)
...
![High level architecture diagram for this project](/images/blog/getting-started-on-kubernetes-observability-with-ebpf/architecture-diagram.webp)
...
![TCP output engine](/images/blog/getting-started-on-kubernetes-observability-with-ebpf/tcp-output-engine.webp)
...
![Still with me?](/images/blog/getting-started-on-kubernetes-observability-with-ebpf/its-that-easy-meme.webp)
...
![The components of a Kubernetes cluster](/images/blog/getting-started-on-kubernetes-observability-with-ebpf/kubernetes-components.webp)
...
![We are almost done!](/images/blog/getting-started-on-kubernetes-observability-with-ebpf/yaml-files-meme.webp)
...
![Number of bytes ingested per minute by port and the pod name](/images/blog/getting-started-on-kubernetes-observability-with-ebpf/prometheus-dashboard.webp)
